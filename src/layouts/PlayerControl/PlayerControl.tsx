      ...
      return (
         <div
            ...
            className={`min-[900px]:h-[90px] h-[61px] playerControl ${
               isShowLyric ? 'bg-transparent !bottom-0 !bg-none' : 'bg-secondary border-t border-t-gray-700'
         ...
         >
                  ...
                  <Tooltip content={isRandomSong ? 'Tắt phát ngẫu nhiên' : 'Bật phát ngẫu nhiên'}>
                     <button
                        ...
                        className={`p-2.5 hover:bg-white min-[900px]:block hidden ${
                           isShowLyric && '!block'
                        } hover:bg-opacity-10 rounded-full ${!atAlbum && 'text-secondary cursor-not-allowed'} ${
            ...
            >
               {infoSong.mvlink && (
                  <Tooltip content={'MV'}>
                     <Link
                        href={infoSong.mvlink}
                        className={`p-2 block hover:bg-white hover:bg-opacity-10 rounded-full`}
                     >
                        <svg
                           xmlns='http://www.w3.org/2000/svg'
                           fill='none'
