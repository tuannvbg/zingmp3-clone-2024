         ...
         <ul>
            {list?.map((item, index) => (
               <li
                  ...
                  } rounded-md items-center text-secondary text-xs p-2.5 ${!isRanking && 'border-b border-b-gray-800'}`}
               >
                  <div className='w-[50%] flex items-center gap-x-2'>
                     <span
                        className={`text-[32px] w-12 text-center text-transparent font-black mr-2 ${
                           index === 0
                              ? 'text-stroke1'
                              : index === 1
                              ? 'text-stroke2'
