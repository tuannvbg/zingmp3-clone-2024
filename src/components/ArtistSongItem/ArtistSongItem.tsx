         ...
         <div className='hidden group-hover:flex items-center'>
            {item.mvlink && item.isWorldWide && (
               <Tooltip content={'Xem MV'}>
                  <Link
                     href={item.mvlink}
                     className={`p-2 text-white block hover:bg-white hover:bg-opacity-10 rounded-full
                  `}
                  >
                     <svg
                        xmlns='http://www.w3.org/2000/svg'
            ...
            <Tooltip left content={library.includes(item.encodeId) ? 'Xoá khỏi thư viện' : 'Thêm vào thư viện'}>
               <button
