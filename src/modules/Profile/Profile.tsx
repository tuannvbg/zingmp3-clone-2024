...
export default function Profile() {
   ...
   return (
      <form
         ...
         onSubmit={onSubmit}
         className='flex flex-wrap-reverse mt-10 md:flex-nowrap gap-y-10 md:gap-x-5 lg:gap-x-12 font-bold italic'
      >
                  ...
                  <div className='input-dist'>
                     <div className='input-type'>
                        ...
                        <div className='flex flex-col sm:flex-row items-center gap-y-1 gap-x-5'>
                           <div className='w-full sm:w-[20%] sm:text-right capitalize sm:-translate-y-3'>Tên:</div>
                           <Input
                              name='name'
