...
export default function MyMusic() {
   const { currentSongId, playlistLibrary, songsLibrary, setAtAlbum, setRecentSong, isLoadingSong, isPlaying } =
   ...
   return (
      <div className={`mt-[70px] px-14 ${currentSongId ? 'pb-28' : 'pb-10'}`}>
         ...
         {playlistLibrary.length > 0 ? (
            <HomeList title list={playlistLibrary as HomeListType[]} />
         ) : (
         ...
         <div className='mt-12 mb-5 flex items-center gap-x-10 border-b border-b-gray-800'>
            <h2 className='text-base font-semibold py-2.5 border-b-2 border-b-tprimary'>BÀI HÁT</h2>
            <h2 className='text-base font-semibold py-2.5'>MV</h2>
         </div>
