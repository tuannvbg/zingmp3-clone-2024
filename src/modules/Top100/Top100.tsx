...
export default function Top100() {
   ...
   return (
      <div className={`mt-[70px] px-14 ${currentSongId ? 'pb-28' : 'pb-10'}`}>
         ...
         {top100List.map((top100) => (
            <Fragment key={top100.title}>
               <h2 className='text-xl font-bold mt-12 mb-5'>{top100.title}</h2>
               <HomeList list={top100.items as HomeListType[]} all title />
            </Fragment>
         ))}
      </div>
   )
